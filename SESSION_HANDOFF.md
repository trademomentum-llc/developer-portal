...
- **gitea-com:** current `main` push is the next required step.
- **origin (local Gitea):** URL is `http://localhost:3333/openchoreo/developer-portal.git`; current `main` push is pending.
